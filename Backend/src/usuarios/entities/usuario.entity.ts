...
// 'superadmin' gestiona tenants y usuarios globalmente (sin tenant_id fijo);
// 'admin' gestiona su finca dentro de su tenant;
// 'propietario' gestiona su finca; 'empleado' tiene acceso de solo lectura.
export enum Rol {
