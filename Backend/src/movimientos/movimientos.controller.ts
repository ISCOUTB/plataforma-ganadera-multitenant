...
export class MovimientosController {
  ...
  @ApiOperation({
    summary: 'Mover un animal a otro potrero (con validación de capacidad)',
  })
  @ApiResponse({
    status: 201,
    description: 'Movimiento registrado y animal actualizado',
  })
  @Post()
  moverAnimal(
  ...
  @ApiOperation({
    summary: 'Listar todos los movimientos del tenant (paginado)',
  })
  ...
  update(
    ...
    return this.movimientosService.update(id, dto, tenantId, user.sub);
  }
